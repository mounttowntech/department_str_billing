...
app.use("/api/department-categorys", require("./src/routes/department-categorysRoutes"));
app.use("/api/department-sub-categorys", require("./src/routes/department-sub-categorysRoutes"));
