...
    console.log(`:white_check_mark: Email sent to ${to}`);
  } catch (error) {
    console.error(`:x: Failed to send email to ${to}`);
...
      console.log(":white_check_mark: Welcome email sent.");
    } catch (mailError) {
      console.error(":x: Welcome email failed.");
...
      console.log(":white_check_mark: Login email sent.");
    } catch (mailError) {
      console.error(":x: Login email failed.");
      console.error(mailError);
    }
